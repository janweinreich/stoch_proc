...
\begin{align}
  ...
  \frac{1}{2 \pi} \lim_{T \rightarrow \infty} 
   ...
   \frac{1}{ 2 \pi} \log(a^2)
\end{align}
Thus the average value can take an arbitrary value and is not uniquely definied.
...
\begin{figure}[H]
  ...
  and due to infinite standart deviation. Thus we cannot expected this quantities to be defined and
  ...
  It appears the average value is equally distribed with accross the real numbers.
  This is plausible because we have shown that the first momentum of
  the Cauchy distribution can take arbitrary values.
  \begin{figure}[H]
    \centering
      \includegraphics[width=0.45\linewidth]{./figures/JanWeinreich_P1_4c.png}
      \caption{In blue: Distibution of the average positions of 200 independent
      Cauchy Walkers. }
      \label{fig:abb7}
    \end{figure}
